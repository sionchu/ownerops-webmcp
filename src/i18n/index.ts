...
type UiCopy = {
  ...
  schedule: {
    ...
    costSummary: {
      ...
      totalHours: string;
      weeklyHours: string;
      scheduledWage: string;
      actualWage: string;
      actualWageCumulative: string;
      scheduledToday: string;
      currentActualWageCumulative: string;
...
const UI: Record<UiLocale, UiCopy> = {
  en: {
    ...
    schedule: { weekTitle: "Week of August 24", dayTitle: "Day of {date}", day: "Day", week: "Week", viewSelector: "Schedule view", selectDate: "Select business date", teamMember: "Team member", committed: "Committed", agentProposal: "Agent proposal", humanEdit: "Human edit", reviewed: "Reviewed", uncovered: "Uncovered", openCoverage: "Open coverage", needsAssignment: "Needs assignment", dragHelp: "Drag any shift to a worker/day cell. During preview, your reassignment updates the candidate without committing it.", manualEdit: "Manual schedule edit", reassign: "Reassign", close: "Close", teamMemberField: "Team member", workDay: "Work day", manualHelp: "This uses the same live action as drag/drop and WebMCP. If a preview is open, only the candidate changes.", cancel: "Cancel", saveAssignment: "Save assignment", costSummary: { workerCount: "Staff working", totalHours: "Total hours", weeklyHours: "Weekly hours", scheduledWage: "Scheduled wage estimate", actualWage: "Actual wage", actualWageCumulative: "Actual wage to date", scheduledToday: "Today scheduled", currentActualWageCumulative: "Current actual wage to date", expectedVsActual: "vs scheduled", laborRatio: "Labor vs sales", reviewNeeded: "Review needed", peopleSuffix: " people", hoursSuffix: " h", planDelta: "Scheduled wage estimate change" } },
  ...
  ko: {
    ...
    schedule: { weekTitle: "8월 24일 주간", dayTitle: "{date} 일간", day: "일간", week: "주간", viewSelector: "스케줄 보기", selectDate: "영업일 선택", teamMember: "팀원", committed: "확정", agentProposal: "에이전트 제안", humanEdit: "사람이 수정", reviewed: "검토 완료", uncovered: "미배정", openCoverage: "미배정 커버리지", needsAssignment: "배정 필요", dragHelp: "근무를 팀원/요일 셀로 드래그하세요. 미리보기 중에는 후보만 바뀌고 확정 스케줄은 변경되지 않습니다.", manualEdit: "수동 스케줄 수정", reassign: "재배정", close: "닫기", teamMemberField: "팀원", workDay: "근무일", manualHelp: "드래그앤드롭 및 WebMCP와 동일한 실시간 액션을 사용합니다. 미리보기가 열려 있으면 후보만 변경됩니다.", cancel: "취소", saveAssignment: "배정 저장", costSummary: { workerCount: "근무 인원", totalHours: "총 근무시간", weeklyHours: "주간 근무", scheduledWage: "예상 스케줄 임금", actualWage: "실근무 임금", actualWageCumulative: "실근무 임금 누계", scheduledToday: "오늘 예정", currentActualWageCumulative: "현재 실근무 누계", expectedVsActual: "예정 대비", laborRatio: "매출 대비 인건비", reviewNeeded: "검토 필요", peopleSuffix: "명", hoursSuffix: "시간", planDelta: "예상 스케줄 임금 변경" } },
  ...
  ja: {
    ...
    schedule: { weekTitle: "8月24日の週", dayTitle: "{date}の日", day: "日", week: "週", viewSelector: "スケジュール表示", selectDate: "営業日を選択", teamMember: "チームメンバー", committed: "確定", agentProposal: "エージェント提案", humanEdit: "人が編集", reviewed: "レビュー済み", uncovered: "未配置", openCoverage: "未配置カバレッジ", needsAssignment: "割当が必要", dragHelp: "シフトをメンバー/曜日セルへドラッグしてください。プレビュー中は候補だけが変わり、確定スケジュールは変更されません。", manualEdit: "手動スケジュール編集", reassign: "再割当", close: "閉じる", teamMemberField: "チームメンバー", workDay: "勤務日", manualHelp: "ドラッグ&ドロップと WebMCP と同じライブ操作です。プレビュー中は候補のみ変更されます。", cancel: "キャンセル", saveAssignment: "割当を保存", costSummary: { workerCount: "勤務人数", totalHours: "合計勤務時間", weeklyHours: "週間勤務", scheduledWage: "予定スケジュール賃金", actualWage: "実勤務賃金", actualWageCumulative: "実勤務賃金累計", scheduledToday: "本日の予定", currentActualWageCumulative: "現在の実勤務賃金累計", expectedVsActual: "予定比", laborRatio: "売上比人件費", reviewNeeded: "確認が必要", peopleSuffix: "人", hoursSuffix: "時間", planDelta: "予定スケジュール賃金の変更" } },
  ...
  es: {
    ...
    schedule: { weekTitle: "Semana del 24 de agosto", dayTitle: "Día del {date}", day: "Día", week: "Semana", viewSelector: "Vista del horario", selectDate: "Seleccionar día operativo", teamMember: "Miembro del equipo", committed: "Confirmado", agentProposal: "Propuesta del agente", humanEdit: "Edición humana", reviewed: "Revisado", uncovered: "Sin cubrir", openCoverage: "Cobertura abierta", needsAssignment: "Necesita asignación", dragHelp: "Arrastra un turno a una celda de persona/día. Durante la vista previa solo cambia el candidato, no el horario confirmado.", manualEdit: "Edición manual del horario", reassign: "Reasignar", close: "Cerrar", teamMemberField: "Miembro del equipo", workDay: "Día de trabajo", manualHelp: "Usa la misma acción en vivo que arrastrar/soltar y WebMCP. Si hay una vista previa, solo cambia el candidato.", cancel: "Cancelar", saveAssignment: "Guardar asignación", costSummary: { workerCount: "Personal en turno", totalHours: "Horas totales", weeklyHours: "Horas semanales", scheduledWage: "Estimación salarial programada", actualWage: "Salario real", actualWageCumulative: "Salario real acumulado", scheduledToday: "Programado hoy", currentActualWageCumulative: "Salario real acumulado actual", expectedVsActual: "frente a lo programado", laborRatio: "Personal frente a ventas", reviewNeeded: "Revisar", peopleSuffix: " personas", hoursSuffix: " h", planDelta: "Cambio de salario programado" } },
  ...
  "zh-CN": {
    ...
    schedule: { weekTitle: "8月24日当周", dayTitle: "{date} · 单日", day: "单日", week: "每周", viewSelector: "排班视图", selectDate: "选择营业日", teamMember: "团队成员", committed: "已确认", agentProposal: "智能体建议", humanEdit: "人工修改", reviewed: "已审核", uncovered: "未覆盖", openCoverage: "待覆盖", needsAssignment: "需要分配", dragHelp: "将班次拖到成员/日期单元格。预览期间只更新候选方案，不会更改已确认排班。", manualEdit: "手动编辑排班", reassign: "重新分配", close: "关闭", teamMemberField: "团队成员", workDay: "工作日", manualHelp: "这里与拖放和 WebMCP 使用同一实时操作。存在预览时只修改候选方案。", cancel: "取消", saveAssignment: "保存分配", costSummary: { workerCount: "出勤人数", totalHours: "总工时", weeklyHours: "每周工时", scheduledWage: "预计排班工资", actualWage: "实际工资", actualWageCumulative: "实际工资累计", scheduledToday: "今日排班预计", currentActualWageCumulative: "当前实际工资累计", expectedVsActual: "与排班预计相比", laborRatio: "工资/销售额", reviewNeeded: "需要复核", peopleSuffix: "人", hoursSuffix: "小时", planDelta: "预计排班工资变更" } },
