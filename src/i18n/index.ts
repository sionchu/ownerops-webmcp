...
const UI: Record<UiLocale, UiCopy> = {
  ...
  ko: {
    ...
    metrics: { coverage: "커버리지", recoveryCost: "복구 비용", scheduleChanges: "스케줄 변경", reviewFlags: "검토 항목", covered: "커버 완료", noGap: "피크 공백 없음", actionNeeded: "조치 필요", candidateImpact: "현재 후보 기준", selectOption: "대응 옵션을 선택하세요", committed: "확정", appliedPlan: "적용된 계획", liveSchedule: "현재 스케줄", needsReview: "검토 필요", clear: "이상 없음" },
  ...
  ja: {
    ...
    metrics: { coverage: "カバレッジ", recoveryCost: "復旧コスト", scheduleChanges: "スケジュール変更", reviewFlags: "レビュー項目", covered: "対応済み", noGap: "ピーク不足なし", actionNeeded: "対応が必要", candidateImpact: "現在の候補", selectOption: "対応案を選択", committed: "確定済み", appliedPlan: "適用済みプラン", liveSchedule: "現在のスケジュール", needsReview: "確認が必要", clear: "問題なし" },
  ...
  "zh-CN": {
    ...
    rail: { ownerOpsAgent: "OwnerOps 智能体", sharedStateActivity: "共享状态活动", checkingSharedState: "正在检查共享状态", liveSharedState: "实时共享状态", agentNotConnected: "智能体未连接", checkingBrowser: "正在检查浏览器能力", manualStillWorks: "仍可手动编辑排班", candidatePlan: "候选方案", humanEdit: "人工修改", reviewed: "已审核", agentProposal: "智能体建议", addedPayroll: "恢复成本", weeklyHours: "每周工时", warnings: "警告", covered: "已覆盖", minutesGap: "分钟缺口", localImpactPending: "影响已更新 · 等待智能体审核", reviewedReady: "已按当前实时状态审核 · 可应用", previewUncommitted: "仅预览 · 已确认排班未更改", nextAgentAction: "下一步智能体操作", evaluateCurrentPlan: "审核当前方案", rereadExactEdit: "让智能体重新读取人工修改后的准确候选方案。", tryAsking: "试着让智能体处理", sameLiveSchedule: "结构化审核始终基于同一份实时排班。", laborRatio: "人工成本率" },
    ...
    metrics: { coverage: "覆盖情况", recoveryCost: "恢复成本", scheduleChanges: "排班变更", reviewFlags: "复核项", covered: "已覆盖", noGap: "高峰无缺口", actionNeeded: "需要处理", candidateImpact: "当前方案", selectOption: "请选择恢复方案", committed: "已提交", appliedPlan: "已应用方案", liveSchedule: "当前排班", needsReview: "需要复核", clear: "无异常" },
